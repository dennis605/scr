...
ActivePresentation.Slides(8).Shapes("Status APT").TextFrame.TextRange.Copy
wordDoc.Paragraphs(1).Range.PasteAndFormat wdFormatPlainText
wordDoc.Content.InsertParagraphAfter
'wordDoc.Content.InsertParagraphAfter

ActivePresentation.Slides(8).Shapes("APT").TextFrame.TextRange.Copy

    'wordDoc.Paragraphs(2).Range.PasteSpecial , , , , wdPasteBitmap
wordDoc.Paragraphs(2).Range.PasteAndFormat wdChartPicture
wordDoc.Content.InsertParagraphAfter
    
ActivePresentation.Slides(8).Shapes("Status ADP").TextFrame.TextRange.Copy
wordDoc.Paragraphs(3).Range.PasteAndFormat wdFormatPlainText
wordDoc.Content.InsertParagraphAfter
    
ActivePresentation.Slides(8).Shapes("ADP").TextFrame.TextRange.Copy
